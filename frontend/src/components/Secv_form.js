      ...
      <body class="bg-white flex items-center justify-center min-h-screen">
        <div class="bg-black text-white p-8 md:p-16 rounded-2xl w-full max-w-6xl border border-white">
            <h1 class="text-[#E86931] text-3xl md:text-4xl font-bold mb-6 md:mb-10">Header</h1>
                ...
                <p class="text-white text-lg md:text-xl font-bold mb-8 md:mb-12">Стоимость: <span class="font-bold">бесценно</span></p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
        ...
        <div>
          <textarea name="comment" placeholder="Комментарий..." 
                    class="h-full w-full p-4 md:p-6 bg-white text-black placeholder-black border-none rounded-2xl text-lg md:text-xl focus:outline-none"></textarea>
        </div>
      </div>
